...
alert("Hola bienvenido al CALCULADORcom");
...
function mensaje() {
  alert("Gracias por utilizar la calculadora " + nombre);
  console.log(
    "Gracias por utilizar la calculadora " +
      nombre +
      "\nF5 para volver a iterar."
  );
}
...
function mult(n1, n2) {
  ...
  alert(
    "MULTIPLICACION REALIZADA EXITOSAMENTE\n\n En la consola aparecen los resultados, gracias."
  );
}
...
function divi(n1, n2) {
  ...
  alert(
    "DIVISION REALIZADA EXITOSAMENTE\n\n En la consola aparecen los resultados, gracias."
  );
}
